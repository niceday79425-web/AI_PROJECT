...
<head>
  ...
  <style>
    ...
    .post-hero h1 {{ font-size:clamp(1.5rem,4vw,2.4rem);font-weight:900;line-height:1.4;max-width:820px;margin:0 auto 1rem; }}
    .post-content {{ max-width:860px;margin:0 auto;padding:2.5rem 1.5rem; }}
    .post-content h2 {{ font-size:1.4rem;font-weight:700;color:#1e1b4b;margin:2.5rem 0 1rem;border-left:4px solid #6366f1;padding-left:0.75rem; }}
    .post-content h3 {{ font-size:1.15rem;font-weight:700;color:#2d2a5e;margin:1.8rem 0 0.75rem; }}
    .post-content p {{ line-height:2.0;color:#374151;margin-bottom:1.2rem; }}
    .post-content ul, .post-content ol {{ padding-left:1.5rem;margin-bottom:1.2rem; }}
    .post-content li {{ line-height:2.0;color:#374151;margin-bottom:0.5rem; }}
    .post-content strong {{ color:#1e1b4b; }}
    .key-point {{ background:#f0f4ff;border-left:4px solid #6366f1;border-radius:0 10px 10px 0;padding:1rem 1.25rem;margin:1.5rem 0; }}
    .key-point strong {{ color:#4338ca; }}
    .data-table {{ width:100%;border-collapse:collapse;margin:1.5rem 0;font-size:0.92rem; }}
    .data-table th {{ background:#1e1b4b;color:#fff;padding:0.75rem 1rem;text-align:left; }}
    .data-table td {{ padding:0.7rem 1rem;border-bottom:1px solid #e5e7eb;color:#374151; }}
    .data-table tr:nth-child(even) td {{ background:#f9fafb; }}
    .nav-links {{ display:flex;gap:1rem;flex-wrap:wrap;margin:2rem 0;padding:1rem;background:#f8f9fb;border-radius:10px; }}
    .nav-links a {{ color:#6366f1;text-decoration:none;font-weight:600;font-size:0.9rem; }}
    .author-box {{ display:flex;align-items:center;gap:1rem;background:#f8f9fb;border:1px solid #e5e7eb;border-radius:12px;padding:1rem 1.2rem;margin-bottom:2rem; }}
    ...
    .disclaimer {{ margin-top:3rem;padding:1.25rem 1.5rem;background:#fff7f7;border-left:4px solid #ef4444;border-radius:10px;font-size:0.83rem;color:#666;line-height:1.7; }}
    .back-btn {{ display:inline-flex;align-items:center;gap:0.4rem;color:#6366f1;font-weight:600;text-decoration:none;font-size:0.9rem;margin-bottom:1.5rem; }}
    .series-nav {{ background:#f0f4ff;border-radius:12px;padding:1.25rem 1.5rem;margin-top:3rem; }}
    .series-nav h3 {{ color:#4338ca;font-size:1rem;margin-bottom:0.75rem; }}
    .series-nav ul {{ list-style:none;padding:0;margin:0; }}
    .series-nav li {{ padding:0.3rem 0;font-size:0.9rem; }}
    .series-nav a {{ color:#6366f1;text-decoration:none; }}
  </style>
</head>
<body>
